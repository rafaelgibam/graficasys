    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <table class="table table-hover">
                ...
                <tbody>
                <?php foreach ($fc->getA()->findAll() as $key => $value) : ?>
                    <tr>
                        <td><?= $value->id ?></td>
                        <td><?= $value->cpf ?></td>
                        <td><?= $value->rg ?></td>
                        ...
                        <td><a href="atendente?a=e&id=<?= $value->id ?>"><i style="font-size: 1.6em;" class="ion-edit mr-2"></i></a>
                            <a href="atendente?a=d&id=<?= $value->id ?>"><i style="font-size: 1.8em; color: red;" class="ion-trash-b"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <form action="Pages/trataform/trataform.php" method="post">
                    ...
                    <button type="submit" name="editarAtendente" class="btn btn-primary"><span class="ion-person-add mr-2"></span>Atualizar</button>
                    <a href="/atendente" class="btn btn-danger"><span class="ion-android-cancel mr-2"></span>Cancelar</a>
                </form>
            </div>
        </div>
    <?php else: ?>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <form action="Pages/trataform/trataform.php" method="post">
                    ...
                    <button type="submit" name="cadastrarAtendente" class="btn btn-primary"><span class="ion-person-add mr-2"></span>Cadastrar</button>
                </form>
            </div>
        </div>
    <?php endif; ?>
